//in diesem Beispiel wird der Positionsmodus gewählt und gestartet, nach dem Triggersignal wird eine vorgegebene Position angefahren (Flagpositionsmodus) 
...
//3. Schritt: State maschine hochfahren	
	...
	{	
		...
		{
			Out.TargetPosition = In.ActualPosition + 2000;   ////setzt die Zielposition abhängig von der Istposition
